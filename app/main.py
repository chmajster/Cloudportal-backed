...
from app.api import administration, automation, health, infrastructure, ipam, proxmox_management
...
for router in (auth.router, administration.router, infrastructure.router, automation.router, ipam.router, proxmox_management.router, health.router):
