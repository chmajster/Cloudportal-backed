...
function jobStageInfo(item) {
  ...
  const exact = {
    ...
    'proxmox.clone_template.cloning': 'Klonowanie VM',
    'proxmox.clone_template.waiting_clone': 'Oczekiwanie na klonowanie w Proxmox',
    'proxmox.clone_template.converting': 'Konwersja klona do template',
    'proxmox.clone_template.waiting_template': 'Oczekiwanie na konwersję do template',
    'proxmox.clone_template.verifying': 'Weryfikacja template i źródłowej VM',
    'proxmox.clone_template.completed': 'Template utworzony',
